...
subtitle: "Concepts of and Data for Measuring Overlooked Forms of Congressional Oversight"
...
### Overight investigations inform agency policy 
...
Citing those investigations and hearings, Levin here writes in support of a proposed rule form the Treasury Financial Crimes  Enforcement Network
...
???
Here, senator leving writes to the IRS, entering an Committee Report into the recored suppoerting the rule. 
...
Here is another example: Senator Levin writes this letter chastising 5 agencies for being too slow to make rules

---

### Legislators inform statutory interprtation
...
### Legislators inform how agencies use descretionary authority
...
### Uneven attention to agency rulemaking over time 
...
### More expierneced members do more policy work
...
# Interest groups mobililze oversight
...
```{r coded-support, out.width= "60%", fig.cap="Hand-coded Comments By Type and Position on Proposed Rule"}
...
```{r, fig.cap="", fig.show = "hold", out.width = "75%"}
...
```{r mo-success-did, fig.cap="", fig.show = "hold", out.width = "60%"}
...
- While this often makes legislators on the same side as corporations, controlling for policy position, legislators are slightly more likely to support public interest coalitions
...
nothing super interesting about this joint comment from members of Congress, just that they support the rule, but could be another example https://www.regulations.gov/comment/NOAA-NOS-2013-0091-0188
-->
...
Democrats demand a stronger rule on wages and low-income individuals. [The House comment has 77 signatories.](https://www.regulations.gov/comment/WHD-2019-0001-59350)
...
Indiana Senator Richard Lugar submits a letter on behalf of a constituent. I noticed that in the from-line, it has Ocean Conservancy, and the email is save the animals. https://www.regulations.gov/comment/FWS-R9-ES-2008-0093-8940
